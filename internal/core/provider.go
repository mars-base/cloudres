...
func Columns(provider, resourceType string) []string {
	...
	case "cms-ct":
		return []string{"ID", "Name", "Mail", "SMS", "Groups"}
	case "cms-cg":
	...
	case "ack":
		return []string{"ID", "Name", "State", "Version", "Type", "Region", "Nodes", "Created"}
	case "acr":
...
func (r Resource) Detail() [][2]string {
	...
	case "ram":
		return r.ramDetail()
	case "cms-ct":
		return r.cmsContactDetail()
	case "cms-cg":
		return r.cmsCGDetail()
	case "cms-alert":
		return r.cmsAlertDetail()
	case "arms-ct":
		return r.armsContactDetail()
	case "arms-cg":
...
func (r Resource) Row() []string {
	...
	case "ram":
		return r.ramRow()
	case "cms-ct":
		return r.cmsContactRow()
	case "cms-cg":
		return r.cmsCGRow()
	case "cms-alert":
		return r.cmsAlertRow()
	case "arms-ct":
		return r.armsContactRow()
	case "arms-cg":
